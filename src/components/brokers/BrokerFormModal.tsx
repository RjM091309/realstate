...
const FIELD_TEXTAREA =
  'min-h-[72px] resize-y rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm focus-visible:border-brand-blue focus-visible:ring-brand-blue/20 dark:border-slate-600 dark:bg-slate-950/80';
    ...
    <FormField label={label} span={span}>
      <div
        className={cn(
          ...
          hasFile
            ? 'border-brand-blue/20 dark:border-brand-blue/40'
